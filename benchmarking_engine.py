...
NEIGHBORHOOD_CLUSTERS = {
    "UWS_UES":    ["Upper West Side", "Upper East Side", "Morningside Heights",
                   "Carnegie Hill", "Yorkville", "Lenox Hill", "Harlem",
                   "Washington Heights"],
    "MIDTOWN":    ["Midtown West", "Midtown East", "Midtown", "Murray Hill",
                   "Turtle Bay", "Hell's Kitchen", "Gramercy", "Kips Bay",
                   "Sutton Place", "NoMad"],
    "DOWNTOWN":   ["Greenwich Village", "West Village", "SoHo", "TriBeCa",
                   "Tribeca", "Flatiron", "Chelsea", "NoHo", "Nolita",
                   "Little Italy", "Financial District", "Battery Park City"],
...
def benchmark_building(vendor_summary: dict, units: int = 100,
    ...
    for category, baseline in BASELINE_BENCHMARKS.items():
        ...
        results.append({
            ...
            "peer_p75": p75,
            "peer_p90": p90,
            # Aliases for JS template compatibility
            "network_p25": p25,
            "network_median": p50,
            "network_p50": p50,
            "network_p75": p75,
